        ...
        >
            <div className="max-w-4xl mx-auto text-center">
                ...
                <motion.div
                    ...
                    className="mb-12"
                >
                    <button className="group relative px-12 py-6 bg-gradient-to-br from-brand-primary to-brand-accent rounded-full overflow-hidden transform hover:-translate-y-1 transition-all duration-300 shadow-[0_0_50px_-10px_rgba(0,255,148,0.5)]">
